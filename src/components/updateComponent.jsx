...
class Update extends Component {
            ...
            <div className="container-fluid">
                <div className="row ">
                    <div className="col-md-12 text-center sub-div">
                        Generate Update for data in table.
                        <hr/>
                        This will generate Update, Update class, Data View table and connection class.
                        <hr/>
                    </div>
                </div>
                {
                            ...
                            <div className="col-md-12">
                                <ul className="nav nav-tabs" id="myTab" role="tablist">
                                    <li className="nav-item">
                                        <a className="nav-link active" id="home-tab-upd" data-toggle="tab" href="#view-update"
                                           role="tab" aria-controls="home" aria-selected="true">HTML View</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" id="update-tab" data-toggle="tab" href="#update-update"
                                           role="tab" aria-controls="update" aria-selected="true">HTML update View</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" id="profile-tab" data-toggle="tab" href="#controller-update"
                                           role="tab" aria-controls="profile" aria-selected="false">Controller</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" id="contact-tab" data-toggle="tab" href="#select-update"
                                           role="tab" aria-controls="contact" aria-selected="false">Select Class</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" id="contact-tab" data-toggle="tab" href="#updateQuery-update"
                                           role="tab" aria-controls="contact" aria-selected="false">Update Class</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link" id="connection-tab" data-toggle="tab" href="#connection-update"
                                           role="tab" aria-controls="contact" aria-selected="false">Connection Class</a>
                                    </li>
                                </ul>
                                <div className="tab-content" id="myTabContent">

                                    <div className="tab-pane fade show active" id="view-update" role="form"
                                    ...
                                    <div className="tab-pane fade show " id="update-update" role="form"
                                         aria-labelledby="home-tab">
                                    <pre className="code-view-pre">
                                        {generatedUpdate}
                                    </pre>
                                    ...
                                    <div className="tab-pane fade" id="controller-update" role="tabpanel"
                                    ...
                                    <div className="tab-pane fade" id="connection-update" role="tabpanel"
                                         aria-labelledby="contact-tab">
                                        <pre className="code-view-pre">{generatedConnection}</pre>
                                    </div>

                                    <div className="tab-pane fade" id="select-update" role="tabpanel"
                                         aria-labelledby="contact-tab">
                                    <pre className="code-view-pre">
                                        {generatedSelectQuery}
                                    </pre>
                                    </div>
                                    <div className="tab-pane fade" id="updateQuery-update" role="tabpanel"
                                         aria-labelledby="contact-tab">
                                    <pre className="code-view-pre">
                                        {generatedUpdateQuery}
                                    </pre>
    ...
    generateData(event) {
        ...
        this.setState({
            ...
            generatedView: HtmlFile.generateView(this.state.tableName, this.state.tableData, "update", "yes", "no", "yes", "no", "no", "no"),
            generatedUpdate: HtmlFile.generateView(this.state.tableName, this.state.tableData, "update", "no", "yes", "no", "no", "yes", "no"),
            generatedController: PhpController.generateController(this.state.tableName, this.state.tableData, "update", "no", "yes", "WHERE " + this.state.tableName + "_ID = \". $updateId .\"", "yes"),
